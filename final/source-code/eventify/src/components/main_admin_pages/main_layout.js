...
import '../../assets/admin/main_page.scss';
import Dashboard from './dashboard/dashboard';
import Management from './management/management';
import ManageEvents from './event/events';
...
const MainPage = ({logout}) => {
    ...
    const [notifications, setNotifications] = useState(() => {
        axios.post(`${serverRouter}admin/notifications`, {email})
        .then(res => {
    ...
    function close(index, id) {
        ...
        setTime(new Date);
        axios.post(`${serverRouter}admin/set_notification`, {id})
            .then(res => {})
    }
                ...
                <div className="main_page_menu">
                    <div className="col-md-2">
                        <ul className="menu">
                            ...
                            <li className={menu == 2 ? 'active' : ''} onClick={() => setMenu(2)}><i className="bi bi-person-plus-fill" /><p>Management</p></li>
                            <li className={menu == 3 ? 'active' : ''} onClick={() => setMenu(3)}><i className="bi bi-calendar4-event" /><p>Manage Events</p></li>
                            <li className={menu == 4 ? 'active' : ''} onClick={() => setMenu(4)}><i className="bi bi-ticket-fill" /><p>Tickets Dash</p></li>
                            <li className={menu == 5 ? 'active' : ''} onClick={() => setMenu(5)}><i className="bi bi-info-circle" /><p>Information Desk</p></li>
