...
const Information = ({data, updates}) => {
    ...
    function update () {
        ...
        axios.post(`${serverRouter}admin/profile_set`, {currentId, forname, surname, username, currentEmail , email, phone, currentPass, newPass})
            .then((res) => {
        ...
        <>
            ...
            <form>
                <div className="general">
                    ...
                    <div className="info mt-3">
                        <p>Role:</p>
                        <select name="pets" onChange={(event) => {setRole(event.target.value)}}>
                            <option value=""></option>
                            {
                                roles.map(rol => {
                                    if(rol.action == 0) {
